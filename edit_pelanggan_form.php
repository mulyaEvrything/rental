            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php 
                    ...
                    $query = $koneksi->query("SELECT * FROM tbpelanggan WHERE id_pelanggan=$id");
                    $data = $query->fetch_assoc();
                    $o = explode(',', $data['jk']);
                ?>
              <form action="edit_pelanggan_action.php" method="POST">
                ...
                <div class="form-floating">
                  ...
                  <textarea class="form-control" placeholder="Masukkan Alamat" id="floatingTextarea" name="alamat_pelanggan"><?php echo $data['alamat_pelanggan']?></textarea>
                </div>

                <div class="form-group">
                  <label>No Handphone</label>
                  <input type="text" name="no_hp_pelanggan" class="form-control" value="<?php echo $data['no_hp_pelanggan']?>">
                </div>
                <div class="form-floating">
                ...
                <div class="form-group">
                  ...
                  <a href="pelanggan_list.php" class="btn btn-danger">kembali</a>
                </div>
