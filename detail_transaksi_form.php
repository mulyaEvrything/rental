        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="barang_list.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Barang</p>
                </a>
              </li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php
                  ...
                  $q = $koneksi->query("SELECT * FROM tbpenyewaan, tbpelanggan, tbadmin 
                    WHERE tbpenyewaan.id_pelanggan = tbpelanggan.id_pelanggan
                    AND tbpenyewaan.id_admin = tbadmin.id_admin
                    AND id_penyewaan = $id");
                  $data = $q->fetch_assoc();
                ?>
                <table class="table">
                  ...
                  <tr>
                    ...
                    <td><?php echo $data['tanggal_harus_kembali'] ?></td>
                  </tr>
                  <tr>
              ...
              <form method ="POST" action="add_detail_action.php">
                <?php
                  $no = 1;
                  $id = $_GET['id_penyewaan'];
                  $q = $koneksi->query("SELECT * FROM tbpenyewaan, tbdetail_penyewaan, tbbarang 
                    WHERE tbpenyewaan.id_penyewaan = tbdetail_penyewaan.id_penyewaan
                    AND tbbarang.id_barang = tbdetail_penyewaan.id_barang 
                    AND tbdetail_penyewaan.id_penyewaan = $id");
                  while($data = $q->fetch_assoc()){ ?>
                    <tr>
                      ...
                      <td>
                        <a href="delete_detail_action.php?id_penyewaan=<?= $data['id_penyewaan'] ?>&id_barang=<?= $data['id_barang']?>"
                ...
                <?php } ?>
                  <tr>
                      <td colspan="2">
                        <input type="hidden" name="id_penyewaan" value="<?php echo $id; ?>">
                        <select name="id_barang" class="form-control">
                        <?php
                          $q = $koneksi->query("SELECT * FROM tbbarang");
                          while($m = $q->fetch_assoc()){ ?>
                          <option value="<?php echo $m['id_barang'] ?>">
