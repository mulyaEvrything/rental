          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php 
                    $id = $_GET['id_admin'];
                    $query = $koneksi->query("SELECT * FROM tbadmin WHERE id_admin=$id");
              ...
              <form action="edit_admin_action.php" method="POST">
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_admin" class="form-control" value="<?php echo $data['nama_admin']?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <a href="admin_list.php" class="btn btn-danger">kembali</a>
                  </div>
